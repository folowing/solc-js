...
JavaScript bindings for the [Tron Solidity compiler](https://github.com/tronprotocol/solidity/).
...
There are two ways to use `tron-solc-js`:
...
**Note:**
If you are using Electron, `nodeIntegration` is on for `BrowserWindow` by default. If it is on, Electron will provide a `require` method which will not behave as expected and this may cause calls, such as `require('tron-solc-js')`, to fail.
...
The `linker` module (`require('tron-solc-js/linker')`) offers helpers to accomplish this.

The `linkBytecode` method provides a simple helper for linking:

```javascript
var linker = require('tron-solc-js/linker');
...
```javascript
var abi = require('tron-solc-js/abi');
...
```
var translate = require('tron-solc-js/translate')
...
```javascript
var wrapper = require('tron-solc/wrapper');
...
```javascript
import * as wrapper from 'tron-solc-js/wrapper';
